...
LINKML_SCHEMA_NAME=linkml_tut
LINKML_SCHEMA_AUTHOR=Phillip Berger <pbkush@hotmail.de>
LINKML_SCHEMA_DESCRIPTION=linkml-tut
LINKML_SCHEMA_SOURCE_PATH=src/linkml_tut/schema/linkml_tut.yaml
